...
const SpotifyNowPlaying = (props) => {
	...
	// Watch for changes in the 'result' state
	useEffect(() => {
		if (result.isPlaying) {
	...
	return (
		<div
			className={`flex min-w-md w-[250px] h-fit text-white items-center justify-center p-2 text-base rounded-lg border-gray-dark ${backgroundColor}`}>
			{loading ? (
